...
def delete_csvs():
    """Delete the CSV files for the last 10, 20, 30, 40, and 50 played songs and the top 5 artists."""
    song_counts = [10, 20, 30, 40, 50]
    for count in song_counts:
        song_file_name = f'last_{count}_played_songs.csv'
        artist_file_name = f'top_5_artists_last_{count}_songs.csv'
